            ...
            <div className="container mx-auto px-6 relative z-10">
                ...
                <div className="grid md:grid-cols-2 max-w-6xl mx-auto items-center gap-12">
                    ...
                    <div className="space-y-6 text-center md:text-left">
                        ...
                        <p className="text-gray-700 dark:text-gray-300 text-lg leading-relaxed">
                            I am currently a <strong className="text-purple-600 dark:text-purple-400">frontend-focused MERN developer</strong> with experience in CRUD operations and working with REST APIs on the backend.
                            My favorite part of development is building <strong className="text-purple-600 dark:text-purple-400">creative, user-friendly interfaces</strong> that not only work well but also look great.
                        </p>

                        <p className="text-gray-700 dark:text-gray-300 text-lg leading-relaxed">
                            Outside of coding, I'm admittedly a bit lazy (😅), but I have a strong interest in <strong className="text-green-600 dark:text-green-400">football</strong>
