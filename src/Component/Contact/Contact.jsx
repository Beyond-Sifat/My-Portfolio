...
const Contact = () => {
    ...
    const { scrollYProgress: leftProgress } = useScroll({
        target: leftRef,
        offset: ["0.2 1", "0.2 0.7"]  // enter & exit animation
    });

    const { scrollYProgress: rightProgress } = useScroll({
        target: rightRef,
        offset: ["0.2 1", "0.2 0.7"]
    });

    const leftX = useTransform(leftProgress, [0, 1], [-80, 0]);
    const leftOpacity = useTransform(leftProgress, [0, 1], [0, 1]);

    const rightX = useTransform(rightProgress, [0, 1], [80, 0]);
            ...
            <div className="container mx-auto px-6 max-w-6xl relative z-10">
                ...
                <div className="grid md:grid-cols-2 gap-12">
                    ...
                    <motion.div
                        ...
                        className="bg-white/80 dark:bg-gray-800/80 backdrop-blur-sm rounded-2xl shadow-lg hover:shadow-xl dark:shadow-blue-900/20 dark:hover:shadow-blue-900/30 p-8 transition-all duration-300 border border-white/20 dark:border-gray-700/30"
                    >
